...
$host = "localhost";
$user = "root";
$password = "11135984"; // Replace with your password
$dbName = "easy_share";
...
if ($_SERVER["REQUEST_METHOD"] == "POST" && isset($_POST['register'])) {
    ...
    $insertQuery = "INSERT INTO  `user`(`name`, `email`, `pass`) VALUES (?, ?, ?)";
...
<head>
    ...
    <title>Easy Share - Register</title>
                    ...
                    <div class="col-lg-6">
                        <div class="p-5">
                            ...
                            <form class="user" method="POST" action="#">
                                ...
                                <hr />
                                <a href="index.php" class="btn btn-google btn-user btn-block"> <i class="fab fa-google fa-fw"></i> Register with Google </a>
                                <a href="index.php" class="btn btn-facebook btn-user btn-block"> <i class="fab fa-facebook-f fa-fw"></i> Register with Facebook </a>
                            </form>
                            <hr />
                            <div class="text-center">
